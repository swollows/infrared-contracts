...
interface IBGT is IPOLErrors, IERC20, IERC20Metadata, IVotes {
     ...
     */
    event BeaconDepositContractChanged(
        address indexed previous, address indexed current
    );
     ...
     */
    event QueueBoost(
        address indexed sender, bytes indexed pubkey, uint128 amount
    );
    ...
    event Redeem(
        address indexed from, address indexed receiver, uint256 amount
    );
    ...
    event UpdateCommission(
        bytes indexed pubkey, uint256 oldRate, uint256 newRate
    );
     ...
     */
    function setCommission(bytes calldata pubkey, uint256 reward) external;
     ...
     */
    function boostedQueue(address account, bytes calldata pubkey)
        external
        view
     ...
     * @param pubkey The pubkey of the validator being boosted.
     */
    function boosted(address account, bytes calldata pubkey)
        external
        view
        returns (uint128);
     ...
     */
    function commissions(bytes calldata pubkey)
        external
        view
        returns (uint32 blockTimestampLast, uint224 rate);
     ...
     */
    function boostedRewardRate(bytes calldata pubkey, uint256 rewardRate)
        external
        view
        returns (uint256);
     ...
     */
    function commissionRewardRate(bytes calldata pubkey, uint256 rewardRate)
        external
        view
        returns (uint256);
    ...
    /**
     * @notice Returns the BeraChef interface.
     */
    function beraChef() external view returns (IBeraChef);

    /**
     * @notice Returns the BGT staker for boosts.
     */
    function staker() external view returns (IBGTStaker);
     ...
     */
    function setBeaconDepositContract(address _beaconDepositContract)
        external;
