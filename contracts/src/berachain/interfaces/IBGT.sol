...
interface IBGT is IPOLErrors, IERC20, IERC20Metadata {
     ...
     */
    event QueueBoost(
        address indexed sender, address indexed validator, uint128 amount
    );
    ...
    event UpdateCommission(
        address indexed validator, uint256 oldRate, uint256 newRate
    );
     ...
     * @param validator The address of the validator being boosted.
     */
    function boosted(address account, address validator)
        external
        view
        returns (uint128);
     ...
     */
    function commissions(address validator)
        external
        view
     ...
     */
    function boostedRewardRate(address validator, uint256 rewardRate)
        external
        view
        returns (uint256);
     ...
     */
    function commissionRewardRate(address validator, uint256 rewardRate)
        external
        view
        returns (uint256);
