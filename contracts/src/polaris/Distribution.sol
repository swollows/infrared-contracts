...
interface IDistributionModule {
     ...
     */
    function getWithdrawAddress(address delegator)
        external
        view
        returns (address);
     ...
     */
    function getAllDelegatorRewards(address delegator)
        external
        view
        returns (ValidatorReward[] memory);

    /**
     * @dev Returns the total rewards accumulated by the delegator.
     * @param delegator The delegator to retrieve the totalRewards for.
     */
    function getTotalDelegatorReward(address delegator)
        external
        view
        returns (Cosmos.Coin[] memory);
