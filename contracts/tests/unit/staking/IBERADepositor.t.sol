...
import {IDepositContract} from "@berachain/staking/IDepositContract.sol";
import {DepositContract} from "@berachain/staking/DepositContract.sol";
...
contract IBERADepositorTest is IBERABaseTest {
    ...
    function testExecuteDepositsToDepositContract() public {
        ...
        uint64 depositCount = DepositContract(DEPOSIT_CONTRACT).depositCount();
