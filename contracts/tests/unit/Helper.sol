...
// import {IERC20Mintable} from 'solidity/core/Interfaces/IERC20Mintable.sol';

// // Mocked Contracts.
// import {MockDistributionModule} from 'solidity/tests/unit/MockDistributionModule.sol';
// import {MockStakingModule} from 'solidity/tests/unit/MockStakingModule.sol';
// import {MockERC20Module} from 'solidity/tests/unit/MockERC20Module.sol';
// import {MockRewardsModule} from 'solidity/tests/unit/MockRewardsModule.sol';
...
//     _vestingFactory = new IREDVestingFactory(
//             address(1),
//             address(2),
//             address(3)
//         );
...
//     _daiVault =
//       InfraredVault(address(_infrared.registerVault(address(_dai), 'Dai Vault', 'DAIV', _rewardTokens, POOL_ADDRESS)));
//   }
...
//   function _mockBeginRedelegations(address _validator, address _newValidator, uint256 _amount, bool _succeed) internal {
//     vm.mockCall(
//       address(_stakingPrecompile),
